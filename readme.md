...
- Loja Tünkers (Nome do plugin)
- ltk (nome dos arquivos, nome do text domain e slug da url do repositório)
- LTK_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- ltk_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Loja Tünkers, através do próprio sistema de atualizações do WordPress
